...
grid(a1,'on');
hold(a1,'all');
ylabel('Bend Angle [degrees]', 'FontSize',14) % label left y-axis
...
grid(a2,'on');
hold(a2,'all');
ylabel('Pressure [kPa]', 'FontSize',14) % label right y-axis
xlabel('Volume [mL]', 'FontSize',14) % label x-axis
...
ylabel('Bend Angle [degree]', 'FontSize',14) % label x-axis
