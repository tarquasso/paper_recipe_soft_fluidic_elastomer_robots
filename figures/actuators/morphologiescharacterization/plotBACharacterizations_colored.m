function plotBACharacterizations_colored()
% cyl = cylindrical
% rib = ribbed
% ple = pleated
close all
...
errorBendangle = 0.2/62.7*180/pi; %[deg] http://www.naturalpoint.com/optitrack/products/flex-3/specs.html
errorForce = 8.9* 0.05; %[N]http://www.futek.com/product.aspx?stock=FSH00093
...
%angle_err = ones(length(cyl_volume),length(cyl_curvature));
h3 = errorbar(cyl_energy, cyl_curvature*cyl_length*DEG_PER_RAD);
set(h3, 'Color', 'k');
set(h3, 'LineStyle', '-');
