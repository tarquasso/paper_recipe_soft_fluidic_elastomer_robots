...
\begin{figure}[htb]
        \centering
                    \includegraphics[width=0.9\columnwidth]{figures/actuators/tail_design_v2.pdf}
        \caption[Fish's soft tail as a ribbed fluidic elastomer actuator]{Fish's soft tail as an example for a ribbed fluidic elastomer actuator.}
            \label{fig:fish_tail_design}
\end{figure}
