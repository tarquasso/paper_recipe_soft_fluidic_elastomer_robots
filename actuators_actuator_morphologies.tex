...
%
Each segment's geometry and cavity volume is different, because every actuator segment was build for a different type of robot prototype in mind. The geometries and the resulting cavity volumes are listed in Table~\ref{tab:ComparativeCharacterization}.
%Table 
\begin{table}[htb]
...
%
The different cavity volumes and the different characteristic deformation behavior of each morphology under pressurization requires significantly different volumetric displacements. 
%
